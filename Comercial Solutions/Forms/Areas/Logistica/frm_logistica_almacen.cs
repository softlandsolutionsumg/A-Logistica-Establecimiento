    ...
    public partial class frm_logistica_almacen : Form
    {
        ...
        public void cargaralmacenes(string tipo)
        {
            ...
            try
            {
                if (tipo.Equals("1")) {
                    // tipo activos
                    query = "select nombre_bodega as Nombre,tbm_ambiente_idtbm_ambiente as Ambiente,tbm_medidas_idtbm_medidas as Medida,alto as Alto,ancho as Ancho,fondo as Fondo from tbm_almacen where tbm_establecimiento_cod_establecimiento='" + IDESTABLECIMIENTO + "' AND tbm_estadoestablecimiento_idtbm_estadoestablecimiento='1'";
               
                }
                if (tipo.Equals("2"))
                {
                    // tipo inactivos
                    query = "select nombre_bodega as Nombre,tbm_ambiente_idtbm_ambiente as Ambiente,tbm_medidas_idtbm_medidas as Medida,alto as Alto,ancho as Ancho,fondo as Fondo from tbm_almacen where tbm_establecimiento_cod_establecimiento='" + IDESTABLECIMIENTO + "' AND tbm_estadoestablecimiento_idtbm_estadoestablecimiento='2'";
